...
def index_view(request):
    ...
    return render(request, 'catflix/index.html', {
        'data': data.items(),
...
def register_view(request):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'catflix/register.html', locals())
    else:
...
def login_view(request):
    ...
    if request.method == 'GET':
        ...
        return render(request, 'catflix/login.html', locals())
    else:
...
def watch_movie_view(request):
    ...
    try:
        ...
        movie = None
    return render(request, 'catflix/watch_movie.html', {'movie': movie})